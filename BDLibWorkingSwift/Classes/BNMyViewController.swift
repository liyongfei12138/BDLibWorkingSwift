...
class BNMyViewController: UIViewController ,UIWebViewDelegate{
    ...
    var progressView = BNProgressView(frame: CGRect(x: 0, y: 0, width: kDeviceWidth, height: 4))
    
    let myView = UIWebView(frame: CGRect(x: 0, y: kDeviceStatusHeight, width: kDeviceWidth, height: kDeviceHeight - kDeviceStatusHeight))
